        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-3 mt-6">
              <button
                onClick={() => setRatesOpen(false)}
                className="w-full py-2.5 bg-slate-100 hover:bg-slate-200 text-slate-700 font-semibold rounded-lg transition-colors"
              >
                Close
              </button>
              <button
                onClick={handleApply}
                className="w-full py-2.5 bg-[#002D62] hover:bg-[#001b3b] text-white font-semibold rounded-lg transition-colors shadow-sm"
              >
                Apply Now
              </button>
            </div>
