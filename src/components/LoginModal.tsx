...
import { X, Lock, ShieldCheck, User, Eye, EyeOff, CheckCircle2, AlertCircle } from 'lucide-react';
          ...
          <div className="p-6 space-y-5">
            ...
            <div className="pt-3 border-t border-slate-100 flex items-center justify-between text-xs text-slate-500">
              ...
              <button
                ...
                onClick={() => {
                  setLoginOpen(false);
                  alert('To enroll in Eastern Online Banking, please click Open Account or visit any branch with valid ID.');
                }}
